...
module.exports = (function() {
  ...
  var Base = function(graph) {
    ...
    this.hide = function(val) {
      ...
      if (that.cardinalityElement()) that.cardinalityElement().classed('hidden', val);
    };
    ...
    this.draw = function(labelGroup) {
      ...
      if (that.inverse()) {
        ...
        that.labelElement().attr('transform', 'translate(' + 0 + ',-' + yTransformation + ')');
        that
          .inverse()
          .labelElement()
    ...
    this.drawHalo = function(pulseAnimation) {
      ...
      if (that.labelElement() && that.labelElement().node()) {
        ...
        if (that.animationProcess() === false) labelContainer.appendChild(labelNode);
      }
    ...
    this.raiseDoubleClickEdit = function(forceIRISync) {
      ...
      that
        .labelElement()
        .selectAll('rect')
        .classed('hoveredForEditing', true);
      that.frozen(true);
