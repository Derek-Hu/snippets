module.exports = function(graph) {
  ...
  Domain_dragger.setParentProperty = function(parentProperty, inverted) {
    ...
    if (parentProperty.domain() === parentProperty.range()) Domain_dragger.isLoopProperty = true;
  ...
  Domain_dragger.svgRoot = function(root) {
    if (!arguments.length) return Domain_dragger.rootElement;
  ...
  Domain_dragger.drawNode = function() {
    Domain_dragger.pathElement = Domain_dragger.pathLayer.append('line').classed('classNodeDragPath', true);
  ...
  Domain_dragger.updateElementViaRangeDragger = function(x, y) {
    ...
    Domain_dragger.nodeElement.attr(
      'transform',
      'translate(' + ep_range_x + ',' + ep_range_y + ')rotate(' + angle + ')'
    );
  ...
  Domain_dragger.onMouseOut = function() {
    if (Domain_dragger.mouseButtonPressed === true) return;
    Domain_dragger.nodeElement.classed('classDraggerNodeHovered', false);
    Domain_dragger.nodeElement.classed('classDraggerNode', true);
