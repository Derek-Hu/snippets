...
module.exports = function(graph) {
  ...
  graph.setClassDistance = function(distance) {
    setDistance('classDistance', distance);
  };

  graph.setDataTypeDistance = function(distance) {
    setDistance('datatypeDistance', distance);
  };

  function setDistance(type, distance) {
    var defaultLinkDistance = options[type]();
